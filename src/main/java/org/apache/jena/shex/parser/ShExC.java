...
public class ShExC {
     ...
     * @return ShexShapeMap
     */
    public static ShexShapeMap parseShapeMap(String filename) {
     ...
     * @return ShexShapeMap
     */
    public static ShexShapeMap parseShapeMap(String filename, String baseURI) {
        InputStream input = IO.openFile(filename);
     ...
     * @return ShexShapeMap
     */
    public static ShexShapeMap parseShapeMap(InputStream input, String baseURI) {
        try ( Reader r = setReader(input) ) {
            ShExJavacc parser = new ShExJavacc(r);
     ...
     * @return ShexShapeMap
     */
    public static ShexShapeMap parseShapeMap(StringReader input, String baseURI) {
        ShExJavacc parser = new ShExJavacc(input);
        return parseShapeMap$(parser, baseURI, null);
    }
